...
dependencies {
    ...
    // Si tienes extensiones para credenciales, superuser-seed, etc., añádelas aquí
    // Ejemplo: implementation(project(":extensions:identity-hub:credentials"))
    // Ejemplo: implementation(project(":extensions:superuser-seed"))
}
