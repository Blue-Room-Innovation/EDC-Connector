...
# -----------------------------------------------------------------------------
# Pequeño helper para guardar/actualizar un secreto en el HashiCorp Vault
# del stack local de este repositorio (modo dev en Docker Compose).
#
# Características:
...
#   VAULT_ADDR    → URL del Vault dev (default http://localhost:9200).
#                   En este conector se publica el contenedor `edc-vault` en el
#                   puerto host 9200 que mapea al 8200 interno.
